...
// No Material-UI imports or makeStyles needed

interface TransactionIngestionDialogProps {
    open: boolean;
    onClose: (ingestedSuccessfully?: boolean) => void;
    onIngestionSuccess?: () => void;
}

const TransactionIngestionDialog: React.FC<TransactionIngestionDialogProps> = ({ open, onClose, onIngestionSuccess }) => {
    ...
    const handleUpload = async () => {
        ...
        formData.append('transactions_csv', selectedFile);

        try {
            await api.post('/transactions/ingest-csv', formData, {
                headers: {
            ...
            showSnackbar(`Ingestion failed: ${error.response?.data?.message || error.message}`, 'error');
        } finally {
                ...
                <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-sm sm:max-w-md w-full p-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Ingest Transaction Data (CSV)</h2>
                            <button
                                onClick={() => onClose()}
                        ...
                        <div className="border-t border-b border-gray-200 dark:border-gray-700 py-4 mb-4">
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Upload a CSV file containing transaction data. The file should have columns matching your transaction schema (e.g., `transaction_id`, `user_id`, `amount`, `timestamp`, `is_fraud`, etc.).
                            </p>
                            ...
                            />
                            <label htmlFor="csv-file-upload" className="block cursor-pointer">
...
export default TransactionIngestionDialog;
